...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-20">
      {/* ========================================================================= */}
      {/* 1. HERO SECTION (Warm, Authentic Indian Senior Healthcare)                */}
      {/* ========================================================================= */}
      <section className="relative overflow-hidden pt-6 sm:pt-12 pb-10 sm:pb-16 bg-gradient-to-b from-[#F6F1E8] via-[#FBF9F5] to-[#FBF9F5] border-b border-[#E8E2D8]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#E2D7C5] shadow-xs text-xs font-semibold text-[#0D2329]">
                ...
                <span>India&apos;s Most Trusted Senior Healthcare Network</span>
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-serif-heading font-extrabold text-[#0D2329] tracking-tight leading-[1.14]">
                Hospital-Grade Care, 24/7 Emergency Safety, & Dignity at Home.
              </h1>

              {/* Subtitle */}
              <p className="text-base sm:text-lg text-[#3D685A] font-light leading-relaxed max-w-2xl">
                From sub-15 minute cardiac ambulances to verified ICU nurses, regular doctor bedside visits, and a dedicated &ldquo;Care Daughter&rdquo; for hospital visits — we care for your aging parents like our own family.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
                <Link href="/find-care" className="w-full sm:w-auto">
                  <Button
                    variant="primary"
                    size="lg"
                    className="w-full sm:w-auto font-bold text-sm sm:text-base px-7 py-3.5 shadow-md hover:shadow-lg group"
                    rightIcon={<ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />}
                  >
                    Find Right Care for Parents (60s)
                  </Button>
                </Link>
                ...
                <Button
                  ...
                  className="w-full sm:w-auto text-[#0D2329] border-red-200 bg-red-50/60 hover:bg-red-100 hover:border-red-300 text-sm sm:text-base font-bold"
                >
              ...
              <div className="pt-2 flex flex-wrap items-center gap-5 text-xs text-[#5C6F75]">
                <button
                ...
                >
                  ...
                  <span>National Helpline: +91 11 4084 9900</span>
                </a>
              </div>
              ...
              <div className="pt-4 border-t border-[#E8E2D8] grid grid-cols-3 gap-3 sm:gap-4">
                <div>
                  ...
                  <span className="text-xs text-[#5C6F75]">Indian Families Protected</span>
                </div>
                <div>
                  <span className="block text-2xl sm:text-3xl font-extrabold text-[#3D685A]">
                    &lt; 15 Mins
                  </span>
                  <span className="text-xs text-[#5C6F75]">Emergency Ambulance SLA</span>
                </div>
                <div>
                  <span className="block text-2xl sm:text-3xl font-extrabold text-[#C58F58]">
                    100%
                  </span>
                  <span className="text-xs text-[#5C6F75]">Biometric Verified Staff</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-4/5 bg-[#F6F1E8]">
                <Image
                  ...
                  alt="Dignified Indian elderly mother consulting with caring healthcare specialist at home"
                  fill
                  priority
                  sizes="(max-width: 1024px) 100vw, 40vw"
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0D2329]/85 via-transparent to-transparent" />
                ...
                <div className="absolute top-4 left-4 right-4 bg-white/95 backdrop-blur-md p-3 rounded-2xl shadow-md border border-[#E8E2D8] flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <span className="text-xs font-bold text-[#0D2329] block">24/7 Cardiac SOS Desk</span>
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-[#0D2329]/95 backdrop-blur-md p-4 rounded-2xl border border-white/10 text-white space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-bold text-[#C58F58] flex items-center gap-1">
                      <Activity className="w-3.5 h-3.5" /> Live Family App Telemetry
                    </span>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center text-xs">
                    ...
                    <div className="bg-white/10 p-2 rounded-xl">
                      <span className="text-[10px] text-white/60 block">SpO2 Oxygen</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-6 sm:p-7 border border-[#E8E2D8] shadow-xs text-center space-y-4">
          <p className="text-xs font-bold uppercase tracking-widest text-[#5C6F75]">
            Networked with 120+ NABH & JCI Accredited Hospital Emergency Departments
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif-heading font-bold text-[#0D2329]">
            Everything Your Parents Need to Live Safely & Happily at Home
          </h2>
          <p className="text-sm text-[#5C6F75]">
            We bridge medical emergencies, clinical procedures, daily living assistance, and active social joy.
          </p>
        </div>
      ...
      {/* ========================================================================= */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#F6F1E8] rounded-3xl p-8 sm:p-12 border border-[#E2D7C5] space-y-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="bg-[#0D2329] text-white rounded-3xl p-8 sm:p-14 border border-[#1C4550] shadow-2xl relative overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 space-y-5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-emerald-400 text-xs font-bold">
              ...
              <span>For Children Living in US, UK, Canada, UAE, or Other Indian Cities</span>
            </div>

            <h2 className="text-3xl sm:text-4xl font-serif-heading font-bold text-white leading-tight">
              Living Miles Away? We Are Your Proxy Family on the Ground.
            </h2>

            <p className="text-xs sm:text-sm text-white/70 leading-relaxed font-light">
              When you are thousands of miles away, you don&apos;t have to feel helpless during sudden health crises, hospital visits, or routine daily care.
            </p>
            ...
            <div className="pt-2">
              ...
              >
                Schedule NRI Care Consultation →
              </Button>
            </div>
          </div>
      ...
      {/* ========================================================================= */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#FBF9F5] rounded-3xl p-8 sm:p-12 border border-[#E2D7C5] flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-2 shrink-0">
            ...
            <span className="text-center text-[11px] text-[#5C6F75]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-serif-heading font-bold text-[#0D2329] mt-2">
              Clinical Guides for Adult Children
            </h2>
            <p className="text-sm sm:text-base text-[#5C6F75] mt-1">
