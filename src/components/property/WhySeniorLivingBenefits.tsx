            ...
            <ul className="space-y-3.5">
              {comparisonPoints.cityFlat.map((item, idx) => (
                <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-[#4A2018] leading-relaxed">
                  <div className="w-5 h-5 rounded-full bg-rose-200 text-rose-800 flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">
                    ✕
                  </div>
                  <span>{item}</span>
                </li>
            ...
            <ul className="space-y-3.5">
              {comparisonPoints.seniorLiving.map((item, idx) => (
                <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-[#0D2329] font-medium leading-relaxed">
                  <div className="w-5 h-5 rounded-full bg-emerald-700 text-white flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">
                    ✓
                  </div>
                  <span>{item}</span>
                </li>
