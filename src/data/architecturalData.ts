...
// ----------------------------------------------------------------------------
// 1. HOSPITAL ARCHITECTURAL DEFINITION (117'-10\" × 138'-0\", G+2 30,000 SQ.FT.)
// ----------------------------------------------------------------------------
...
export const HOSPITAL_ROOMS_SECOND: ArchitecturalRoom[] = [
  ...
  },
  {
    ...
    keyFeatures: ['Constant 32°C water temperature', 'Underwater therapeutic jet nozzles', 'Wheelchair hydraulic immersion lift'],
    cadPlanTab: 'hospital-second'
  },
  {
    id: 'H-SF-SEMISHADE',
  ...
  },
  {
    ...
    floor: 'roof',
    zone: 'recreation',
    cadDimension: "39'-2\" × 56'-11\"",
    widthM: 11.94,
    depthM: 17.35,
    areaSqFt: 2230,
    position: [6.5, 9.0, 8.0],
    size: [11.94, 1.1, 17.35],
    description: "Authoritative Open Sky Rooftop Terrace (39'-2\" × 56'-11\") offering panoramic 360-degree views of Jhajjar green fields, herb planters, and morning walking track.",
...
export const RESIDENCE_FOOTPRINT: BuildingFootprint = {
  ...
  widthM: 14.02,
  depthM: 15.39,
  grossBuiltUpSqFt: 6969, // ~2,323 sq.ft. per floor × 3
  floorsCount: 3,
  floorHeightM: 3.2,
  parapetHeightM: 1.0,
  orientation: {
...
export const RESIDENCE_UNITS_DATA = [
  {
    ...
    seniorFeatures: [
      ...
      "Dual grab rails and walk-in shower bench in 4'0\" × 7'2\" toilet",
  ...
  },
  {
    ...
    seniorFeatures: [
      ...
      "Direct access to 5'6\" × 8'0\" elevator and senior stairwell",
